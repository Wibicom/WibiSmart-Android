...
public class WibiSmartGatt {
    ...
    public UUID SPEC_SERVICE_UUID_ENVIRO = UUID.fromString("0000bb40-0000-1000-8000-00805f9b34fb");
    public UUID SPEC_DATA_CHAR_UUID_ENVIRO = UUID.fromString("0000bb41-0000-1000-8000-00805f9b34fb");
    public UUID SPEC_CONF_CHAR_UUID_ENVIRO = UUID.fromString("0000bb42-0000-1000-8000-00805f9b34fb");
