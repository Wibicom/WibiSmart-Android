...
public class WibiSmartGatt {
    ...
    public UUID CO2_SERVICE_UUID_ENVIRO = UUID.fromString("0000cc10-0000-1000-8000-00805f9b34fb");
    public UUID CO2_DATA_CHAR_UUID_ENVIRO = UUID.fromString("0000cc11-0000-1000-8000-00805f9b34fb");
    public UUID CO2_CONF_CHAR_UUID_ENVIRO = UUID.fromString("0000cc12-0000-1000-8000-00805f9b34fb");
    public UUID CO2_PEROÏOD_CHAR_UUID_ENVIRO = UUID.fromString("0000cc14-0000-1000-8000-00805f9b34fb");

    public UUID SPEC_SERVICE_UUID_ENVIRO = UUID.fromString("0000bb10-0000-1000-8000-00805f9b34fb");
    public UUID SPEC_DATA_CHAR_UUID_ENVIRO = UUID.fromString("0000bb11-0000-1000-8000-00805f9b34fb");
    public UUID SPEC_CONF_CHAR_UUID_ENVIRO = UUID.fromString("0000bb12-0000-1000-8000-00805f9b34fb");
    public UUID SPEC_PEROÏOD_CHAR_UUID_ENVIRO = UUID.fromString("0000bb14-0000-1000-8000-00805f9b34fb");
