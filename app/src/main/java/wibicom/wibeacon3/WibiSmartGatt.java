...
public class WibiSmartGatt {
    ...
    public UUID CO2_SERVICE_UUID_ENVIRO = UUID.fromString("0000cc30-0000-1000-8000-00805f9b34fb");
    public UUID CO2_DATA_CHAR_UUID_ENVIRO = UUID.fromString("0000cc31-0000-1000-8000-00805f9b34fb");
    public UUID CO2_CONF_CHAR_UUID_ENVIRO = UUID.fromString("0000cc32-0000-1000-8000-00805f9b34fb");
    public UUID CO2_PEROÏOD_CHAR_UUID_ENVIRO = UUID.fromString("0000cc34-0000-1000-8000-00805f9b34fb");
